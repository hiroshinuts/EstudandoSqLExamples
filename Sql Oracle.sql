...
##########INSERINDO NA TABELA COMPRADORES##########	

INSERT INTO COMPRADORES(ID, NOME, ENDERECO, TELEFONE) VALUES (IDCOMPRADORES_SEQ.NEXTVAL, 'FLAVIO', 'RUA DO OUVIDOR, 123', '(21) 1111-1111');

##########ALTERANDO TABELA COMPRAS PARA GUARDAR KEY DE COMPRADORES##########	

ALTER TABLE COMPRAS ADD(COMPRADOR_ID NUMBER);

##########COLOCANDO O FK EM COMPRAS (JOINS)##########

ALTER TABLE COMPRAS ADD FOREIGN KEY(COMPRADOR_ID) REFERENCE COMPRADORES(ID);

SELECT OBSERVACOES, VALORES, NOME FROM COMPRAS JOIN COMPRADORES ON COMPRAS.COMPRADOR_ID = COMPRADORES.ID;
